...
set(C_PROG_DIR "${CMAKE_CURRENT_LIST_DIR}/../c_programs")
function(is_current_encoding_8_bit ECHO_OUTPUT)
   ...
   # }"
   # )
    file(READ "${C_PROG_DIR}/get_8_bit_encoding.c" c_get_8_bit_encoding) 
    c_compile_and_run( "get_8_bit_encoding" ${ECHO_OUTPUT} "${c_get_8_bit_encoding}" "") 
